As instâncias fornecidas se dividem em dois tipos que são aquelas onde a distância entre os pontos é euclidiana (EUC_2D) 
e as que a distância é pseudo euclidiana (ATT). 

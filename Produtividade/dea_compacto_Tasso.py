...
import copy
'''
Eu quero construir um unico criador de modelos para todos porém eu não tenho tempo 
para definir bem a comunicaçao entre os metodos, ou até entre as classes para cada uma fazer uma parte
'''
#from deapy import *
###########################################
# Codigo Roubado do Professor
#Acho que não é mais porque eu mudei ele inteiro
class DEAData():
    def __init__(self,
                dmu_names       = None,
        ...
        #Eu prefiro dessa forma porque gosto de instanciar um objeto já com valores
    def print(self,codigo:bool=True):
...
data_dist = DEAData(
        ...
        output_values = [
                ...
                [14645900   , 2340509]])
###########################################
# Tem como juntar tudo, usando o pattern de fabrica, 
# porém vai da muito trabalho organizar tudo
# existe muita parte repetida, se eu usasse classes unicas 
# para cada propriedade eu poderia ter infitos modelos, ou um grande gerador
# da pra fazer uma super classe uma classe mãe que uni os metodos iguals

...
{ // escolhe modo do relogio
    ...
    erroAssert_cond(ml.log != NULL,"Cannot open memlog output");
    ...
    erroAssert_cond(retprint>=0,"Nao foi possivel escrever registro");
    return result;
}
...
{ // captura o tempo atual
  ...
  // fecha arquivo de registro
    ...
    erroAssert_cond(retclose == 0,"Nao foi possivel fechar o arquivo de registro");

...
class Data:
    ...
    def get_data(self):
        ...
        FC = {  1: {el: 7500 for el in L[1]},
                2: {el: 15000 for el in L[2]},
                3: {el: 70000 for el in L[3]}}
        ...
        VC = {  1: {(p, el): (375.42/2)/12 for p in P for el in L[1]},
                2: {(p, el): (440.88/2)/12 for p in P for el in L[2]},
                3: {(p, el): 440.88/2 for p in P for el in L[3]}}
